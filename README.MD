⚠️ This app has been migrated away from the original stack described in the article to using [Apollo Stack](http://www.apollodata.com/) for data management. Followup article coming up ⚠️
